...
const page = createDocumentPage({
  ...
  subtitle: 'คลังลิงก์เอกสารมาตรฐานวิศวกรรมจาก Firebase: Document/EN',
  ...
  emptyMessage: 'ไม่พบลิงก์เอกสารใน Firebase Document/EN',
  errorMessage: 'ไม่สามารถโหลดข้อมูลจาก Firebase Document/EN ได้',
  icon: 'fa-folder-open',
  theme: 'green',
